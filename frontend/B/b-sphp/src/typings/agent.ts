...
export interface AgentChatContext {
  /** 当前页面：triage、appointment、consultation、pharmacy、health、doctor_workbench、prescription */
  page?: 'triage' | 'appointment' | 'consultation' | 'pharmacy' | 'health' | 'doctor_workbench' | 'prescription';
  /** 当前选择医院 ID */
  hospital_id?: number;
  /** 当前选中医生 ID */
  doctor_id?: number;
