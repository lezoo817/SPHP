...
/** 购药订单列表项。 */ export interface DrugOrder { id:number; pharmacyName:string; status:string; logisticsStatus?:string; latestLogisticsNode?:string; amountCent:number; expireAt?:string; }
