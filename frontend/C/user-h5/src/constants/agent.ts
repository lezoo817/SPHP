...
/** 首页"智能导诊"入口跳转 AI 助手后自动发送的预设消息。 */
export const HOME_TRIAGE_MESSAGE = '开启智能导诊服务';
/** 首页"在线问诊"入口跳转 AI 助手后自动发送的预设消息。 */
export const HOME_CONSULTATION_MESSAGE = '我想进行在线问诊';

export const AGENT_QUICK_PROMPTS: AgentQuickPrompt[] = [
  { label: '智能导诊', content: HOME_TRIAGE_MESSAGE, description: '描述症状，推荐科室' },
  ...
  { label: '在线问诊', content: HOME_CONSULTATION_MESSAGE, description: '找医生，提交预问诊' },
