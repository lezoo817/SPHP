...
import { hasSearchKeyword, matchesDepartmentKeyword } from '../../utils/home-search';
...
export default function MedicalSearchPage() {
  ...
  async function search() {
    ...
    try {
      ...
      // 科室位置同样是用户查找就诊地点的有效条件。
      const matchedDepartments = allDepartments.filter((item) => matchesDepartmentKeyword(item, normalizedKeyword));
