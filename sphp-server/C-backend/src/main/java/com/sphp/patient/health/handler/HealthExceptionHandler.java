...
import com.sphp.patient.health.controller.HealthController;
...
@RestControllerAdvice(assignableTypes = HealthController.class)
public class HealthExceptionHandler {

    /**
     * 将健康档案业务异常转换为约定 HTTP 状态和统一响应。
     *
    ...
    public ResponseEntity<Result<Void>> handleBusinessException(BusinessException exception) {
        log.warn("C端健康档案异常 code={}, msg={}", exception.getCode(), exception.getMessage());
